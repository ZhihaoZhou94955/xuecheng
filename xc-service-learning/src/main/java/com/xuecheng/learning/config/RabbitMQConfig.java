...
public class RabbitMQConfig {
    ...
    public Queue QUEUE_ADD_DECLARE() {
    ...
    @Bean
    public Binding binding_queue_media_add_processtask(@Qualifier("xc_learning_addchoosecourse") Queue queue, @Qualifier(EX_LEARNING_ADDCHOOSECOURSE) Exchange exchange) {
